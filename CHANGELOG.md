...
- fix(deps): update rust crate toml to 0.9 (#90)
...
- fix(rng): reject seed=0 in bulk generation (#82)
...
- feat: add fixture examples for remaining versioning strategies (#79)
...
- fix: validate hook and file paths for directory traversal (#77)
...
- feat: add fixture examples for missing FerrFlow features (#68)

## [0.14.0] - 2026-04-08

### Features

- feat: add JSON schema for fixture definitions (#66)

## [0.13.0] - 2026-04-08

### Features

- feat: add --verbose flag for detailed generation output (#65)

## [0.12.0] - 2026-04-08

### Features

- feat: add --validate flag for definition validation (#64)

## [0.11.2] - 2026-04-08

### Bug Fixes

- fix: replace panic!() in tree.rs with proper error propagation (#62)
...
- feat: add --help and --version CLI flags (#49)
- feat: add config format fixture definitions (#47)
